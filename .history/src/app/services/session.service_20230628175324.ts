...
export class SessionService {
  ...
  createNewSession(
    ...
    this.http
      .post("https://clapp-368121-70341.firebaseio.com/session.json", newSession)
      .subscribe((res) => {
        console.log(res);
      });
  ...
  updatesession(title: string, description: string) {
    this._currentSession.pipe(take(1)).subscribe(session => {
