...
import { OptionSelectionModalComponent } from '../../Shared/'
@Component({
  selector: "cleaner-su",
...
export class CleanerSignUpComponent implements OnInit {
  ...
  constructor(private router: RouterExtensions, private modalService: ModalDialogService) {}
  ngOnInit() {
  ...
  openAgeSelectionModal() {
    ...
    const modalRef = this.modalService.showModal(OptionSelectionModalComponent, options);
