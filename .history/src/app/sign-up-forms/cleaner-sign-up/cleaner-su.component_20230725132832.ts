...
// Calculate the date 99 years ago from the current date
 minDateYear = currentDate.getFullYear() - 99;
 minDate = new Date(minDateYear, this.currentDate.getMonth(), this.currentDate.getDate());

// Calculate the date 18 years ago from the current date
 maxDateYear = currentDate.getFullYear() - 18;
 maxDate = new Date(this.maxDateYear, this.currentDate.getMonth(), this.currentDate.getDate());
