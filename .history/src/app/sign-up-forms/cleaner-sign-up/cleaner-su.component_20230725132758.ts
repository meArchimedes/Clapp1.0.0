...
const minDateYear = currentDate.getFullYear() - 99;
const minDate = new Date(minDateYear, currentDate.getMonth(), currentDate.getDate());

// Calculate the date 18 years ago from the current date
const maxDateYear = currentDate.getFullYear() - 18;
const maxDate = new Date(maxDateYear, currentDate.getMonth(), currentDate.getDate());
